...
public class DeactivateDataRetentionPolicy extends Contract {
  ...
  private JsonObject createPutRecordArgument(Ledger ledger, JsonObject argument, JsonObject properties) {
    ...
    JsonObject dataRetentionPolicy = getDataRetentionPolicy(ledger, assetId);
    ...
    validateUserPermissions(userProfile, ledger, dataRetentionPolicy);
  ...
  private JsonObject getDataRetentionPolicy(Ledger ledger, String assetId) {
  ...
  private void validateArgument(Ledger ledger, JsonObject arguments, JsonObject properties) {
  ...
  private void validateUserPermissions(
      JsonObject userProfile, Ledger ledger, JsonObject dataRetentionPolicy) {
