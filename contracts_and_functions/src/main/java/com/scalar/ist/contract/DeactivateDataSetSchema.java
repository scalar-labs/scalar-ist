...
public class DeactivateDataSetSchema extends Contract {
  ...
  public JsonObject invoke(Ledger ledger, JsonObject arguments, Optional<JsonObject> properties) {
    ...
    return invokeSubContract(Constants.PUT_ASSET_RECORD, ledger, putRecordArgument);
  }
  ...
  private JsonObject createPutRecordArgument(Ledger ledger, JsonObject arguments, JsonObject properties) {
    ...
    JsonObject dataSetSchema = getDataSetSchema(ledger, assetId);
    ...
    validateUserPermissions(userProfile, ledger, dataSetSchema);
  ...
  private JsonObject getDataSetSchema(Ledger ledger, String assetId) {
  ...
  private void validateUserPermissions(
      JsonObject userProfile, Ledger ledger, JsonObject dataSetSchema) {
    JsonObject validateUserPermissionsArgument =
        Json.createObjectBuilder()
            ...
            .add(
                ...
                Json.createArrayBuilder().add(dataSetSchema.getString(ORGANIZATION_ID)).build())
            .build();
