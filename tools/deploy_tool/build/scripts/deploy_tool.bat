...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %DEPLOY_TOOL_OPTS%  -classpath "%CLASSPATH%" com.scalar.ist.tools.DeployTool %*
...
if not ""=="%DEPLOY_TOOL_EXIT_CONSOLE%" exit %EXIT_CODE%
exit /b %EXIT_CODE%
